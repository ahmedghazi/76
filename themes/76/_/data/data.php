...
add_action( 'wp_ajax_get_diapo_video_by_id', 'handle_get_diapo_video_by_id' );
add_action( 'wp_ajax_nopriv_get_diapo_video_by_id', 'handle_get_diapo_video_by_id' );
